...
public class LimelightConstantsFactory {
    public static LimelightConstants getConstantsForId(String id) {
        switch (id) {
            ...
            case "test":
                return new LimelightConstants(id, id, 0, null, null, null, null);
            // case "A":
            ...
            // {0., 0., 1.}}
            // ),
            // new InterpolatingUndisortMap((int)Constants.kResolutionWidth,
            // (int)Constants.kResolutionHeight, new UndistortMap_Limelight_A_640x480())
            // );
            // case "B":
            // // Limelight used to procure target coordinates used in unit test
            // return new LimelightConstants(
            ...
            // ),
            // new InterpolatingUndisortMap((int)Constants.kResolutionWidth,
            // (int)Constants.kResolutionHeight, new UndistortMap_Limelight_B_640x480())
            // );
