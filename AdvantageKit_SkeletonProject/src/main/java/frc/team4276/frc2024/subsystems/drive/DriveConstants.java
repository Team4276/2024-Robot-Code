...
import frc.team4276.lib.rev.VIKSparkMaxFactory;
...
public class DriveConstants {
    ...
    public static final VIKSparkMaxFactory.CANSparkMaxPIDFConfig kDrivingPIDFConfig = new VIKSparkMaxFactory.CANSparkMaxPIDFConfig();
    static {
    ...
    public static final VIKSparkMaxFactory.CANSparkMaxPIDFConfig kTurningPIDFConfig = new VIKSparkMaxFactory.CANSparkMaxPIDFConfig();
    static {
