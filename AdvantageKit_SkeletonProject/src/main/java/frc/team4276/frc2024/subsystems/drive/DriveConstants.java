...
public class DriveConstants {
  ...
  public static final SparkMaxFactory.CANSparkMaxPIDFConfig kDrivingPIDFConfig =
      new SparkMaxFactory.CANSparkMaxPIDFConfig();
  ...
  public static final SparkMaxFactory.CANSparkMaxPIDFConfig kTurningPIDFConfig =
      new SparkMaxFactory.CANSparkMaxPIDFConfig();
  ...
  public static final RevUtil.SparkAbsoluteEncoderConfig kTurningEncoderConfig =
      new RevUtil.SparkAbsoluteEncoderConfig();
  ...
  public static final double kMaxAngularVel =
      kMaxVel * 2 / (kTrackWidth * Math.sqrt(2)); // radians per second
