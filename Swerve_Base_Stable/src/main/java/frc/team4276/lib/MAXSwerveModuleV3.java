...
public class MAXSwerveModuleV3 extends Subsystem {
  ...
  public static class mPeriodicIO {
    ...
    // Outputs
    public double desRotRad;
    public double desSpeed;
  }
  ...
  public synchronized void writePeriodicOutputs() {
      m_drivingPIDController.setReference(mPeriodicIO.desSpeed, CANSparkMax.ControlType.kVelocity);
      m_turningPIDController.setReference(mPeriodicIO.desRotRad, CANSparkMax.ControlType.kPosition);
